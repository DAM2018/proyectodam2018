...
/**
 * Abre la ventana de los duenyos
 *
...
public class Duenyo {
    ...
    private String duenyo=Inicio.getLogin().getNombreDue().get(Inicio.getLogin().getDu() - 1);


    /**
     * <p>
     * Controla las acciones permitidas a los duenyos
     *
    ...
    public Duenyo() throws SQLException, ClassNotFoundException {

        JFrame frame = new JFrame("Duenyo");
    ...
    public void datosConfiguracion() throws SQLException {
        ...
        sql = "select nombre,edad,profesion from duenyo where nombredue='" + bienvenida.getText() + "'";
                                        ...
                                        MouseAdapter() {
                                            ...
                                            public void mouseClicked(MouseEvent e) {
                                                ...
                                                try {
                                                    ...
                                                    sql = "update jugador set CodigoEquiJug=?,numaccion=seq3.nextval,administradoroduenyo=? where dnijug='" + tjm.getValueAt(table1.getSelectedRow(), 3).toString() + "'";
                                          ...
                                          MouseAdapter() {
                                              ...
                                              public void mouseClicked(MouseEvent e) {
                                                  ...
                                                  try {
                                                      ...
                                                      sql = "update jugador set CodigoEquiJug='0',administradoroduenyo=? where dnijug='" + tjm2.getValueAt(table2.getSelectedRow(), 3).toString() + "'";
                                                  ...
                                                  MouseAdapter() {
                                                      ...
                                                      public void mouseClicked(MouseEvent e) {
                                                          ...
                                                          try {
                                                              ...
                                                              sql = "update duenyo set nombre=?,edad=?,profesion=? " +
                                                   ...
                                                   public void mouseClicked(MouseEvent e) {
                                                       ...
                                                       if (textField1.getText().equals(textField2.getText()) &&
                                                           ...
                                                           try {
                                                               Connection conexion = Conexion.conexion;
                                                               PreparedStatement st;
                                                               String sql = "update duenyo set nombredue=?,passworddue=? where " +
                                                                       "equidue=?";
                                                               st = conexion.prepareStatement(sql);
